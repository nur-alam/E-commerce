            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    <div class="panel-heading" style="border-bottom:0;">
                        <h3 class="panel-title"> Products of this order </h3>
                    </div>
                        ...
                        <ul>
                            ...
                            @foreach($order->products as $product)
                                <li style="margin-bottom: 10px;">
                                    ...
                                    <div>Product id: {{ $product->price }}</div>
                                    <div>Quantity : {{ $product->pivot->qty }}</div>
                                    <div>Product image: <img src="{{ asset('/storage/'.$product->image ) }}"
                    ...
                    <div class="panel-heading" style="border-bottom:0;">
                        <h3 class="panel-title"> User details of this order </h3>
                    </div>
                    ...
                    <div class="panel-body">
                        <ul>
                            <li style="margin-bottom: 10px;">
                                ...
                                <div>User photo: <img src="{{ asset('/storage/'.$order->user->avatar ) }}"
                                                         style="max-width: 100px;max-height: 100px;" alt="">
                                </div>
                            </li>
                        </ul>

            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="main_blog_details">
                        <img class="img-fluid" src="{{ asset('storage/'.$data['post']->image) }}" alt="{{$data['post']->title}}">
                        <a href="#"><h4>{{$data['post']->title}}</h4></a>
                        <div class="user_details">
                            <div class="float-left">
                                <?php $keywords = explode(',',$data['post']->meta_keywords) ?>
                            ...
                            <div class="float-right mt-sm-0 mt-3">
                                <div class="media">
                                    <div class="media-body">
                                        <h5>{{ $data['post']->user->name }}</h5>
                                        <p>{{ $data['post']->created_at->format("F j, Y, h:s A") }}</p>
                                    </div>
                                    <div class="d-flex">
                                        <img width="42" height="42" src="{{ asset('storage/'.$data['post']->user->avatar) }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
